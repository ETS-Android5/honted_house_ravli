...
public class AppAdsAdapter extends RecyclerView.Adapter<AppAdsAdapter.MyHolder> {
    List<MOREAPPSPLASH> adsResponces;
    Context context;

    public AppAdsAdapter(Context context, List<MOREAPPSPLASH> adsResponces) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        final MOREAPPSPLASH adsResponce = (MOREAPPSPLASH) this.adsResponces.get(position);
